...
<script>
    export default {
        ...
        data() {
            return {
                url:'/assets/images/user_without_avatar.svg',
                submitting:false,
                form: {
                    avatar: null,
                    name: '',
        ...
        methods: {
            ...
            saveUser: function () {
                ...
                axios.post('/users/store', data)
                    .then((response) => {
                        flash('L\'utilisateur a été ajouter avec succes.', 'success');
                        this.formReset();
            ...
            formReset() {
                this.url='/assets/images/user_without_avatar.svg';
                this.form = {
                    name: '',
                    enter_date:null,
                    email: '',
